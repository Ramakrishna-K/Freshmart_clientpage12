...
// // import brown_bread_image from "./brown_bread_image.png"; // ✅ fixed
...
// //   { text: "Organic veggies", path: "Vegetables", image: organic_vegitable_image, bgColor: "#FEF6DA" },
// //   { text: "Fresh Fruits", path: "Fruits", image: fresh_fruits_image, bgColor: "#FEE0E0" },
// //   { text: "Cold Drinks", path: "Drinks", image: bottles_image, bgColor: "#F0F5DE" },
// //   { text: "Instant Food", path: "Instant", image: maggi_image, bgColor: "#E1F5EC" },
// //   { text: "Dairy Products", path: "Dairy", image: dairy_product_image, bgColor: "#FEE6CD" },
// //   { text: "Bakery & Breads", path: "Bakery", image: bakery_image, bgColor: "#E0F6FE" },
// //   { text: "Grains & Cereals", path: "Grains", image: grain_image, bgColor: "#F1E3F9" },
// // ];
